  ...
  return (
    <div className='navbar-container'>
      <div className='navbar-logo'>
        <NavLink to='/'>
          <img src='https://techcabal.com/wp-content/uploads/tc/2020/02/EduTech-logo-1.png'  alt='' />
        </NavLink>
      </div>
...
<span style={{ float: 'right' }}>&gt;</span></NavLink>
      ...
      <div className={`navSection navbar-links ${isMenuOpen ? 'show' : ''}`}>
        <NavLink to='/categories'>EduTech Business</NavLink>
        <NavLink to='/tech'>Tech on EduTech</NavLink>
      </div>
      ...
      <div className={`navbar-auth navbar-links ${isMenuOpen ? 'show' : ''}`}>
        {initialAuthStatus ? (
          ...
          <NavLink to='/mylearning'><h3 className='learning'>My Learning</h3></NavLink></>
        ) : (
          <>
            <NavLink to="/"  activeClassName="active" className='sublist'>
              <button style={{ backgroundColor: 'white', color: 'black', border: '1px solid black' }}>
                Login
              </button>
            </NavLink>
            <NavLink to="/"  activeClassName="active" className='sublist'><button style={{ backgroundColor: '#333' }}>Sign up</button></NavLink>
          </>
        )}
      </div>
